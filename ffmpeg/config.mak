...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/Users/ajph/Documents/projects/qt/beamplay/ffmpeg --disable-shared --enable-static --disable-ffserver --disable-doc --disable-encoders --enable-encoder=libx264 --enable-encoder=aac --enable-encoder=ac3 --enable-encoder=rawvideo --enable-encoder=subrip --enable-encoder=movtext --disable-muxers --enable-muxer=mpegts --enable-muxer=mov --enable-muxer=mp4 --enable-muxer=m4v --enable-muxer=matroska --enable-muxer=avi --enable-muxer=image2 --enable-muxer=srt --enable-muxer=hls --enable-muxer=segment --disable-bsfs --enable-bsf=h264_mp4toannexb --disable-protocols --enable-protocol=file --enable-protocol=pipe --disable-filters --enable-filter=copy --enable-filter=scale --enable-filter=transpose --enable-filter=hflip --enable-filter=vflip --enable-filter=aresample --enable-filter=volume --enable-filter=pad --enable-filter=crop --enable-filter=overlay --enable-filter=color --enable-filter=subtitles --enable-libass --enable-gpl --enable-version3 --enable-libx264 --enable-libtheora --enable-libvorbis --disable-hwaccels --disable-vda --disable-decoder=h264_vda --disable-indevs --enable-indev=lavfi
prefix=/Users/ajph/Documents/projects/qt/beamplay/ffmpeg
...
CFLAGS=   -std=c99 -mdynamic-no-pic -fomit-frame-pointer -fPIC -pthread -I/usr/local/Cellar/libass/0.12.0/include -I/usr/local/Cellar/fontconfig/2.11.1/include -I/usr/local/Cellar/freetype/2.5.3_1/include/freetype2 -I/usr/local/Cellar/fribidi/0.19.6/include/fribidi -I/usr/local/Cellar/freetype/2.5.4/include/freetype2 -I/usr/local/Cellar/x264/r2455/include -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
...
EXTRALIBS=-liconv -L/usr/local/Cellar/x264/r2455/lib -lx264 -lvorbisenc -lvorbis -logg -ltheoraenc -ltheoradec -logg -L/usr/local/Cellar/libass/0.12.0/lib -lass -lm -lbz2 -lz -pthread 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
...
avdevice_FFLIBS=avfilter avformat swscale avcodec swresample avutil
avfilter_FFLIBS=avformat swscale avcodec swresample avutil
